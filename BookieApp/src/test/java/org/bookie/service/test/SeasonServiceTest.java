...
public class SeasonServiceTest {
	...
	public void currentSeasonTest() {
		...
		final Place t1 = this.createPlace("1", "aaa");
		final Place t2 = this.createPlace("2", "aaa");
		final Place t3 = this.createPlace("3", "aaa");
		final Place s1 = this.createPlace("1", "bbb");
		final Place s2 = this.createPlace("2", "bbb");
